...
class MyModelCondExpBase(AbstractPopulationVertex):
    ...
    def get_max_atoms_per_core():
        ...
        # TODO: Ensure the correct class is used below
        return MyModelCondExpBase._model_based_max_atoms_per_core

    @staticmethod
    def set_max_atoms_per_core(new_value):

        # TODO: Ensure the correct class is used below
        MyModelCondExpBase._model_based_max_atoms_per_core = new_value
